...
from stylized_motion.learning.part_layout import FEATURE_GROUP_NAMES, GROUP_COORDINATES, GROUP_NAMES, PART_NAMES, PartFSQLayout
...
class HierarchicalPartFSQMotionAutoencoder(nn.Module):
    ...
    def compute_representation_losses(self, output, batch):
        from .losses import compute_part_representation_losses

        return compute_part_representation_losses(output, batch, self.layout)
